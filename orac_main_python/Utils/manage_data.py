...
class ManageData:
    ...
    def __init__(self, params=None):
        ...
        self.data_paths = params['DataPaths']
        self.data_root_path = self.data_paths['dataRootPath']
        self.mesh_path = self.data_paths['meshDataPath']
        self.gt_path = self.data_paths['gtPclPath']
        self.object_list_txt = self.data_paths['objectList']
        self.result_save_path = self.data_paths['resultSavePath']
        self.candidate_views_txt = self.data_paths['candiateViewsPath']
